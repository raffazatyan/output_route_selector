...
### Changed
- Android: Custom WhatsApp-style bottom sheet dialog instead of system MediaRouteChooserDialog
- Dark theme with rounded corners, icons, and checkmark for active device
